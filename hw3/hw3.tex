...
\Rightarrow a_0 = \frac{5}{4}, \ a_1 = \frac{1}{4}, \ a_{-1} = \frac{1}{4},\ a_2 = \frac{3}{4}, \ a_{-2} = \frac{3}{4} \\ \\ 
...
\begin{center}
 ...
 \end{center}  
 Therefore, \begin{math} y(t) =  \displaystyle\sum_{k=-2}^{2} a_k H(jk\omega_0) e^{jk\omega_0 t} = - \frac{3}{4} \pi j e^{-j\pi t} - \frac{3}{8} \pi j e^{-j\frac{\pi}{2} t} + 0 + \frac{3}{8} \pi j e^{j\frac{\pi}{2} t} + \frac{3}{4} \pi j e^{j\pi t} \\
 y(t) = -\frac{3\pi}{2} \left(\frac{1}{2j} e^{j\pi t} - \frac{1}{2j} e^{-j\pi t}\right)  -\frac{3\pi}{4} \left(\frac{1}{2j} e^{j\frac{\pi}{2} t} - \frac{1}{2j} e^{-j\frac{\pi}{2} t}\right) = -\frac{3\pi}{2} sin(\pi t) - \frac{3\pi}{4} sin(\frac{\pi}{2} t)
 \end{math} 
    \section*{Question 2}
    \subsection*{a)}
