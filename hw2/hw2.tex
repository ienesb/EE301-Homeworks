...
% \newpage
    ...
    y[n] = e^{j\Omega_1 n} + e^{j\Omega_2 n} + \frac{(a^2 -1)}{a^2} e^{j\Omega_1 n} \displaystyle\sum_{k=1}^{\infty} a^{k} e^{-j\Omega_1 k}+ \frac{(a^2 -1)}{a^2} e^{j\Omega_2 n} \displaystyle\sum_{k=1}^{\infty} a^{k} e^{-j\Omega_2 k} 
    \end{math} 
